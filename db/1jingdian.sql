...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2015 at 02:24 AM
...
INSERT INTO `piece` (`id`, `content`, `clicks_count`, `votes_count`, `created_at`, `user_id`, `source_url`, `source`) VALUES
(1, '成功是让自己处于一种舒适的状态下生活。', 121, 1, '2015-03-07 16:00:28', 1, NULL, '黑客'),
(2, '我们如大自然一般自然地过一天吧。不要因硬壳果或掉在轨道上的蚊虫的一只翅膀而出了轨。让我们黎明即起，不用或用早餐，平静而又无不安之感；任人去人来，让钟去敲，孩子去哭，——下个决心，好好地过一天。为什么我们要投降，甚至于随波逐流呢？', 163, 1, '2015-03-07 16:23:45', 1, NULL, '黑客'),
(3, '一路经行处，莓苔见屐痕。白云依静渚，芳草闭闲门。过雨看松色，随山到水源。溪花与禅意，相对亦忘言。 ', 84, 0, '2015-03-07 16:31:58', 1, NULL, '黑客'),
(4, 'Beautiful things don’t ask for attention.', 47, 0, '2015-03-07 22:56:13', 1, NULL, '黑客'),
(5, '优秀的产品从根源上来自核心团队在这个领域独特的理解与想象，他的直觉与品位，武断与偏执。而这些，都与数字KPI全无关系。', 47, 1, '2015-03-09 09:34:04', 1, NULL, '黑客'),
(6, '一个大学毕业生总是想“我需要一份工作”，别人也是这么对他说的，好像变成某个组织的成员是一件多么重要的事情。更直接的表达方式应该是“你需要去做一些人们需要的东西”。即使不加入公司，你也能做到。公司不过是一群人在一起工作，共同做出某种人们需要的东西。真正重要的是做出人们需要的东西，而不是加入某个公司。', 4, 0, '2015-03-11 23:09:30', 1, NULL, '黑客');
